...
import com.example.catchyourmoney.BGraph;
...
public class Report_TabActivity_BU extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dpd = new DatePickerDialog(Report_TabActivity_BU.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        showPieChart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chart = new Intent(Report_TabActivity_BU.this, PChart.class);
        ...
        showBarGraph.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chart = new Intent(Report_TabActivity_BU.this, BGraph.class);
                if (dayFrom != 0 && dayTo != 0) {
                    chart.putExtra("dayFrom", dayFrom);
                    chart.putExtra("dayTo", dayTo);
                    chart.putExtra("monthFrom", monthFrom);
